...
import { Moon, Milk, Baby, Footprints, Square, Sparkles, Trash2 } from "lucide-react";
...
function HomePage() {
  ...
  const wakeMs = Math.max(0, Date.now() - new Date().setHours(0, 0, 0, 0) - sleepMs);
    ...
    <div className="flex flex-col gap-5 px-5 pt-8">
      ...
      <header className="flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <img
            ...
            width={72}
            height={72}
            className="relative size-18 object-contain"
          />
        </div>
      </header>
      ...
      {active && !active.endedAt && (
        <button
          ...
          className="glass-card group relative overflow-hidden rounded-3xl p-5 text-left"
        >
